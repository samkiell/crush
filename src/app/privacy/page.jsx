        ...
        <div className="min-h-screen bg-base-100 pt-24 pb-12 px-4">
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="prose prose-lg max-w-none text-base-content/80">
                    ...
                    <h3>2. Use of Data</h3>
                    <p>
                        Crush EduPlace Intl uses the collected data for various purposes:
                    </p>
                    <ul>
                    ...
                    <p>
                        Crush EduPlace Intl may disclose your Personal Data in the good faith belief that such action is necessary to:
                    </p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of Crush EduPlace Intl</li>
