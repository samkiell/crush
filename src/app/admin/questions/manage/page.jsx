    ...
    const fetchQuestions = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setTotalPages(1); // Assuming single page for now as per current API
            } else {
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="form-control">
                                                ...
                                                <select
                                                    ...
                                                    value={editForm.answer || 'NO CORRECT OPTION'}
                                                    onChange={(e) => setEditForm({ ...editForm, answer: e.target.value })}
                                                >
                                                    <option value="NO CORRECT OPTION">NO CORRECT OPTION</option>
