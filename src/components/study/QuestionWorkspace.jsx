        ...
        const fetchQuestions = async () => {
            try {
                ...
                const formattedQuestions = data.questions.map(q => ({
                    id: q.qid,
                    _id: q._id, // Include for reporting
                    qid: q.qid,
                    subject: q.subject,
                    year: q.year,
                    question: q.question, // Include for reporting
                    text: q.question,
        ...
        <div className="max-w-5xl mx-auto w-full relative pb-20 md:grid md:grid-cols-[1fr_300px] gap-6" {...swipeHandlers}>
            ...
            {showNav && (
                <div className="fixed inset-0 z-40 bg-black/50 backdrop-blur-sm" onClick={() => setShowNav(false)}>
                    <div 
                        className="absolute right-0 top-16 bottom-0 w-72 bg-neutral text-neutral-content backdrop-blur-md border-l border-white/10 p-4 shadow-2xl overflow-y-auto" 
