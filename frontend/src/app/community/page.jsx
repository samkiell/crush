        ...
        <div className="max-w-6xl mx-auto">
              ...
              <form onSubmit={handleCreatePost}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-base-300 rounded-lg focus:ring-2 focus:ring-primary"
                    required
                  />
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {loading ? (
                  ...
                  <div className="space-y-6">
                    {posts.map((post) => (
                      <div
                        key={post.id}
                        className="bg-base-100 rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transition-shadow"
                        ...
                        {post.tags && post.tags.length > 0 && (
                          <div className="mt-4 flex flex-wrap gap-2">
                            {post.tags.map((tag, index) => (
                              <span
                                key={index}
                                className="bg-base-200 text-base-content/70 text-xs px-2 py-1 rounded"
                              >
                                {tag}
                              </span>
                            ))}
            ...
            <div className="lg:col-span-1">
              {currentPost ? (
                <div className="bg-base-100 rounded-lg shadow-md p-6 sticky top-8">
                  ...
                  <div className="border-t border-base-300 pt-4">
                    ...
                    <form onSubmit={handleAddComment}>
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-base-300 rounded-lg focus:ring-2 focus:ring-primary mb-2"
                        required
                      />
                      <button
                        type="submit"
